			...
			<div class="step-pane active" id="step1"> 
				...
				<div class="form-group<?php echo e($errors->has('name') ? ' has-error' : ''); ?>">
					...
					<div class="col-md-12">
						...
						<div class="col-md-4">
							<span> Parent <span class="text text-danger"></span></span>
							<select class="form-control" name="categorie_id_parent">
								<option value=""></option>
		...
		<table id="reunions" class="table table-striped m-b-none datatable"> 
			<thead> 
				<tr>
					...
					<th width="">Catégorie parente</th>
					<th width="">Nombre produits</th>
			...
			<?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categorie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<tr>
					<td><?php echo e($categorie->categorie_id); ?></td> 
					<td><?php echo e($categorie->categorie_nom); ?></td> 
					<td><?php echo e($categorie->categorie_nom_parent); ?></td> 
					<td><?php echo e($categorie->nombre_produits); ?></td> 
					<td><?php echo e(Stdfn::dateTimeFromDB($categorie->categorie_date_creation)); ?></td>
